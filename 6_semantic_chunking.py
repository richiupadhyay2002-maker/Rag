...
if is_valid_key:
    print("Using OpenAI embeddings for semantic chunking...")
    embeddings = OpenAIEmbeddings(openai_api_key=api_key)
else:
    print("Warning: Semantic chunking requires OpenAI embeddings for best results.")
    print("Using HuggingFace embeddings as fallback (may affect quality)...")
